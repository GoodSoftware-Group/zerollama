...
**Pin:** ggml-org **`f95de977`** (tag **b10159**) — [runtime/LLAMA_CPP_PIN.md](./runtime/LLAMA_CPP_PIN.md). Sibling clone defaults to elizaOS for fork kernels; public pin checkout: `LLAMA_CPP_REPO=https://github.com/ggml-org/llama.cpp.git`.
