...
curl -s -o /dev/null -w '%{http_code}\n' -X POST http://localhost:11434/api/embed -d '{}'   # 400/422 = route exists; 404 = missing on this build
curl -s -o /dev/null -w '%{http_code}\n' http://localhost:11434/api/tags   # 200/400 = route exists; 404 = missing on this build
curl -s -o /dev/null -w '%{http_code}\n' -X POST http://localhost:11434/api/embeddings -d '{}'   # 400/422 = route exists; 404 = missing on this build
curl -s -o /dev/null -w '%{http_code}\n' -X POST http://localhost:11434/v1/embeddings -d '{}'   # 400/422 = route exists; 404 = missing on this build
```
