...
enum llm_arch {
    ...
    LLM_ARCH_DFLASH,
    LLM_ARCH_NANBEIGE,
    LLM_ARCH_DFLASH_DRAFT, // milady / Eliza DFlash speculative draft
    LLM_ARCH_QWEN3TTS,
    LLM_ARCH_POCKETTTS,
    LLM_ARCH_MINIMAX_01,
    LLM_ARCH_LAYA, // Laya typed-decision (ModernBERT encoder + decision head)
    LLM_ARCH_UNKNOWN,
};
...
enum llm_kv {
    ...
    // Dual Chunk Attention (Qwen long-ctx / 1M). See docs/dca-dual-chunk-attention.md
    LLM_KV_ATTENTION_DCA_CHUNK_SIZE,
    LLM_KV_ATTENTION_DCA_LOCAL_SIZE,
    LLM_KV_ATTENTION_DCA_ORIG_CTX_LEN,
...
enum llm_tensor {
    ...
    // Laya decision head (post-encoder)
    LLM_TENSOR_LAYA_TYPE_EMBD,
    LLM_TENSOR_LAYA_HEAD_ATTN_NORM,
    LLM_TENSOR_LAYA_HEAD_ATTN_QKV,
    LLM_TENSOR_LAYA_HEAD_ATTN_OUT,
    LLM_TENSOR_LAYA_HEAD_FFN_NORM,
    LLM_TENSOR_LAYA_HEAD_FFN_UP,
    LLM_TENSOR_LAYA_HEAD_FFN_DOWN,
    LLM_TENSOR_LAYA_SCORER_NORM,
    LLM_TENSOR_LAYA_SCORER_FC1,
    LLM_TENSOR_LAYA_SCORER_FC2,
    LLM_TENSOR_LAYA_ACT_FC1,
    LLM_TENSOR_LAYA_ACT_FC2,
};
