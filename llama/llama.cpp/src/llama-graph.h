...
public:
    ...
    ggml_tensor * get_dflash_target_features() const { return t_dflash_target_features; }
    ...
    ggml_tensor * t_dflash_target_features = nullptr; // [n_target_features, n_outputs] per-layer concat
