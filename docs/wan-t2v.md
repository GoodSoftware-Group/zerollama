...
| Wrong torch / import from `venv-training` | Training embed sets `PYTHONPATH`; install script + `training.py` strip it for Wan subprocesses. Rebuild/restart serve after pull. |
