...
```shell
zerollama launch copilot
```

### Run directly with a model

```shell
zerollama launch copilot --model kimi-k2.5:cloud
```
...
```shell
zerollama launch copilot --model kimi-k2.5:cloud --yes -- -p "how does this repository work?"
```
