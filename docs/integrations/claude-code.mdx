...
```shell
zerollama launch claude --model kimi-k2.5:cloud
```
...
```shell
zerollama launch claude --model kimi-k2.5:cloud --yes -- -p "how does this repository work?"
```
...
```shell
zerollama launch claude -- --channels plugin:telegram@claude-plugins-official
```
