...
// Used by kernels/mul_mv.metal (kernel_mul_mv_tq2_0_f32). Patch 0113 dropped
// these as duplicates of the pre-split monolithic shader; they are not defined
// anywhere else after the b10615 per-kind split.
#define N_R0_TQ2_0 4
#define N_SG_TQ2_0 2
