// Shared ggml_metal_buffer_map-equivalent IOSurface → MTLBuffer mapping.
#pragma once
...
static inline id<MTLBuffer> ggml_map_iosurface_base(id<MTLDevice> device,
                                                    void *ptr,
                                                    size_t size,
                                                    void **mappedBase,
                                                    size_t *mappedSize) {
...
static inline IOSurfaceRef ggml_map_surface_from_id(uint32_t surfaceID) {
