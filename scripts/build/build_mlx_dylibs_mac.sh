...
#
# Usage:
#   ./scripts/build/build_mlx_dylibs_mac.sh
#   INSTALL_PREFIX=dist/darwin-arm64 ./scripts/build/build_mlx_dylibs_mac.sh
#   source ./scripts/build/build_mlx_dylibs_mac.sh && build_mlx_dylibs_mac
set -euo pipefail
...
# shellcheck source=scripts/mlx/ensure_mlx_sources.sh
source "${ROOT}/scripts/mlx/ensure_mlx_sources.sh"
