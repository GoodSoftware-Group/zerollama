...
#
# Usage:
#   ./scripts/video/video_agent_cache_smoke.sh
#
...
#   RUN_E2E_VIDEO_AGENT_INFER=1 VIDEO_SMOKE_MODEL=... ./scripts/video/video_agent_infer_smoke.sh
#
...
"${ROOT}/scripts/video/video_expand_cache_smoke.sh"
