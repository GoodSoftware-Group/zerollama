...
#   ./scripts/gpu_harmony_capture.sh
#   ./scripts/gpu_harmony_capture.sh --out /tmp/harmony-capture.json
#
...
if ! "${ROOT}/scripts/phase12_capture_tool_transcript.sh" "$MODEL" "${args[@]}"; then
