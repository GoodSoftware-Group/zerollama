...
grep -q 'BUILD_UMA' "${ROOT}/scripts/build/build_zerollama_mac.sh"
grep -q 'GO_TAGS' "${ROOT}/scripts/build/build_zerollama_mac.sh"
grep -q 'm20_uma_signoff' "${ROOT}/scripts/phase/m20_uma_signoff.sh"
grep -q 'M20_PORT' "${ROOT}/scripts/phase/m20_uma_signoff.sh"
grep -q '11434' "${ROOT}/scripts/phase/m20_uma_signoff.sh"
