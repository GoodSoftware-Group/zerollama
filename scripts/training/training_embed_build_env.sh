...
#
# Usage:
#   source ./scripts/training/training_embed_build_env.sh          # default: 3.11 when python-3.11-embed exists
#   source ./scripts/training/training_embed_build_env.sh 3.10     # explicit
