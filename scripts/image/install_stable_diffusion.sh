...
#
# Usage: ./scripts/image/install_stable_diffusion.sh [--build|--binary] [--models-only]
#
# Downloads:
...
chmod +x "$REPO_ROOT/scripts/image/sd_external_image.sh"
...
echo ""
echo "Register: ./scripts/image/register_sd_models.sh"
