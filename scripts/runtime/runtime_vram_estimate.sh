...
#
#   ./scripts/runtime/runtime_vram_estimate.sh /path/to/model.gguf
#   LLAMA_MODEL=/path/to/model.gguf ./scripts/runtime/runtime_vram_estimate.sh
#   ./scripts/runtime/runtime_vram_estimate.sh model.gguf --num-ctx 8192
#
