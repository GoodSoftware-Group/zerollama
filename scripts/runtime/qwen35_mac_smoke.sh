...
# Override: OLLAMA_HOST=http://127.0.0.1:11434 ./scripts/runtime/qwen35_mac_smoke.sh
#
# Usage:
#   RUN_E2E_QWEN35_MODEL=eliza-1-2b:latest ./scripts/runtime/qwen35_mac_smoke.sh
#   RUN_E2E_QWEN35=1 RUN_E2E_QWEN35_MODEL=eliza-1-2b:latest ./scripts/phase/m3_metal_signoff.sh
#   # Alternate: RUN_E2E_QWEN35_MODEL=qwen3.6:latest
#
# Prerequisite: fresh ./scripts/build/build_zerollama_mac.sh; model pulled locally.
set -euo pipefail
