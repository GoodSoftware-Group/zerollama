...
#
# Usage:
#   M3_LLAMA_MODEL=/path/to/model.gguf ./scripts/phase/l3_cache_smoke.sh
#   CUDA_LLAMA_MODEL=/path/to/7b.gguf L3_PREFIX_REPEAT=150 L3_COMPARE_NO_CACHE=1 ./scripts/phase/l3_cache_smoke.sh
#
# Env:
...
echo "Next: ./scripts/phase/l3_gate_report.sh ${L3_OUT}"
