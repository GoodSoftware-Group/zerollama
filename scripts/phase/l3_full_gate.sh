...
#
# Usage:
#   CUDA_LLAMA_MODEL=/root/eliza-1-9b-256k.gguf ./scripts/phase/l3_full_gate.sh   # Linux CUDA
#   M3_LLAMA_MODEL=/path/to/model.gguf ./scripts/phase/l3_full_gate.sh             # Darwin smoke
set -euo pipefail
...
case "$(uname -s)" in
  Darwin)
    ...
    ;;
  Linux)
    "${ROOT}/scripts/phase/l3_cuda_full_gate.sh"
    ;;
  *)
