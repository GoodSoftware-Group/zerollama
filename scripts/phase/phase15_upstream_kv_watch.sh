...
#
# Usage:
#   ./scripts/phase/phase15_upstream_kv_watch.sh
#   OLLAMA_UPSTREAM_DIR=../ollama-upstream ./scripts/phase/phase15_upstream_kv_watch.sh
#   P15_UPSTREAM_JSON=/tmp/phase15-upstream-kv-watch.json ./scripts/phase/phase15_upstream_kv_watch.sh
set -euo pipefail
