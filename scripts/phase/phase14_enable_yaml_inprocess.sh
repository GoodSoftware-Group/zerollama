...
#
#   RUN_E2E_INPROCESS=1 ./scripts/phase/phase14_backend_smoke.sh   # must pass first
...
echo "  2. RUN_E2E_LLAMA_BACKEND_SOURCE=config ./scripts/phase/phase14_yaml_config_smoke.sh"
