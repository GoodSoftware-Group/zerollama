...
#
# Usage:
#   M3_LLAMA_MODEL=/path/model.gguf ./scripts/phase/l3_spec_cache_smoke.sh
#   L3_SPEC_METHOD=ngram ./scripts/phase/l3_spec_cache_smoke.sh
#   L3_SPEC_METHOD=eagle3 LLAMA_DRAFT_MODEL=/path/draft.gguf ./scripts/phase/l3_spec_cache_smoke.sh
#
# Env:
