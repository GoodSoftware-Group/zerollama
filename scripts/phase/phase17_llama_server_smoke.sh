...
#   M3_LLAMA_MODEL=/path/to/small.gguf ./scripts/phase/phase17_llama_server_smoke.sh
#
# Usage (Linux CUDA):
#   LLAMA_SERVER_BIN=/path/to/llama-server ./scripts/phase/phase17_llama_server_smoke.sh
#   CUDA_LLAMA_MODEL=/path/to/model.gguf ./scripts/phase/phase17_llama_server_smoke.sh
#
# Env:
