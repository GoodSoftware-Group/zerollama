...
#
# Prerequisites:
#   LLAMA_CPP_ROOT=../llama.cpp with Metal build (./scripts/build_llama_server.sh)
#   runtime/.venv (./scripts/mac_setup.sh or runtime_uv_venv.sh)
#
# Usage:
#   ./scripts/serve_llama_cpp_backend.sh
#   LLAMA_CPP_ROOT=~/Sites/inference/llama.cpp ./scripts/serve_llama_cpp_backend.sh
set -euo pipefail
