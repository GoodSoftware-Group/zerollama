...
#
# Prerequisite: ./scripts/apply_llama_vendor_patches.sh && sibling ../llama.cpp
#
# Usage:
#   ./scripts/create_cuda_fork_patch.sh
set -euo pipefail
...
"${ROOT}/scripts/sync_eliza_cuda_fork_to_vendor.sh" "${VENDOR}"
