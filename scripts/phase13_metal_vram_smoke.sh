...
#
# Usage:
#   ./scripts/phase13_metal_vram_smoke.sh
#   M3_LLAMA_MODEL=/path/to/small.gguf ./scripts/phase13_metal_vram_smoke.sh
set -euo pipefail
...
"${ROOT}/scripts/gpu_phase13_snapshot.sh" --gguf "${GGUF}" --num-ctx 4096 >/dev/null
echo "wrote ${P13_OUT}"
