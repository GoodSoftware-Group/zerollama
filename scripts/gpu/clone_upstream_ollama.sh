...
#   OLLAMA_UPSTREAM_DIR=~/Sites/inference/ollama-upstream ./scripts/gpu/clone_upstream_ollama.sh
set -euo pipefail
...
echo ">>> build upstream: ./scripts/build/build_upstream_ollama_mac.sh" >&2
