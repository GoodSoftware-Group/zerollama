...
#
# Usage:
#   ./scripts/gpu/flash_moe_extract_sidecar.sh --model ~/Models/qwen35.gguf --out-dir ~/Models/flash/qwen35
#   ./scripts/gpu/flash_moe_extract_sidecar.sh --model ... --out-dir ... --verify
set -euo pipefail
...
Smoke (startup):
  RUN_E2E_FLASH_MOE_STARTUP=1 FLASH_MOE_GGUF=${MODEL} FLASH_MOE_SIDECAR=${OUT} ./scripts/phase/flash_moe_smoke.sh
EOF
