...
#
#   NVFP4_GGUF=/path/to/nvfp4.gguf ./scripts/gpu/nvfp4_cuda_signoff.sh
#   NVFP4_GGUF=... MXFP4_GGUF=... ./scripts/gpu/nvfp4_cuda_signoff.sh   # format A/B
#
...
"${ROOT}/scripts/gpu/nvfp4_cuda_probe.sh"
