...
#   ./scripts/phase12_capture_tool_transcript.sh gpt-oss:20b
#   ./scripts/phase12_capture_tool_transcript.sh llama3.2:3B --out /tmp/transcript.txt
#   CAPTURE_RUNTIME_URL=http://127.0.0.1:8081/api/chat RUN_E2E_GGUF=... ./scripts/phase12_capture_tool_transcript.sh smoke
#
