...
#
# Prerequisites:
#   ./scripts/build/build_llama_server.sh   # Linux CUDA
#   ./scripts/build/build_ollama_llama_server_darwin.sh   # Mac Metal
#
# Usage:
#   ./scripts/serve/serve_edge.sh
#   LLAMA_SERVER_BIN=/path/to/llama-server ./scripts/serve/serve_edge.sh
set -euo pipefail
