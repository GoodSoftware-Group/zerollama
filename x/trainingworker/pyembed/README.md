...
| `training_shim.c` | `Py_Initialize`, GIL discipline, JSON IPC, native module `fire_oom`. **Why no `Py_Finalize` after torch:** unsafe with PyTorch and the Go runtime; process exit cleans up. |
